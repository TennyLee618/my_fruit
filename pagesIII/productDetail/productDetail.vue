	...
	<view class="container">
		...
		<view class="tui-header-box" :style="{ height: height + 'px', background: 'rgba(255,255,255,' + opcity + ')' }">
			...
			<view class="tui-header-icon" :style="{ marginTop: top + 'px' }" style="border: 1rpx solid #ccc;border-radius: 50rpx;">
				...
				<!-- 1像素竖线 -->
				<view class="tui-icon-box" @tap.stop="openMenu"><tui-icon name="home-fill" :size="20" color="#000"></tui-icon></view>
			</view>
			<tui-tabs
				size="32"
				:tabs="tabs"
				...
				selectedColor="#00C52A"
				sliderBgColor="#00C52A"
				@change="changeNum"
				itemWidth="50%"
			></tui-tabs>
		</view>
		...
		<view :class="[currentTab === 0 ? 'actineclass' : 'errorclass']">
			<view class="tui-banner-swiper">
				<swiper :autoplay="false" :interval="5000" :duration="150" :circular="true" :style="{ height: 520 + 'rpx' }" @change="bannerChange">
					...
					<block v-for="(item, index) in urlList" :key="index">
						<swiper-item :data-index="index"><image :src="item" class="tui-slide-image" :style="{ height: scrollH + 'px' }" /></swiper-item>
					</block>
				</swiper>
			...
			<view class="tui-pro-detail">
				...
				<view class="tui-product-img tui-radius-all">
					<!-- <image src="../../static/images/putao1.png"
					 mode="widthFix"></image> -->
					<view class="" v-html="shopListdata.data.remarks"></view>
				</view>
			</view>
		</view>
		...
		<view class="tui-operation">
			...
			<view class="tui-operation-right tui-right-flex tui-col-7 tui-btnbox-4">
				<view class="tui-flex-1"><tui-button height="68rpx" :size="26" type="danger" shape="circle" @click="showPopup">立即购买</tui-button></view>
				<!-- <view class="tui-flex-1">
					<tui-button height="68rpx" :size="26" type="warning" shape="circle" @click="submit">立即购买</tui-button>
				</view> -->
			</view>
		</view>
		<wyb-popup ref="popup" type="bottom" height="500" width="750" radius="14" mode="size-fixed" :showCloseIcon="true" :scrollY="true" :showScrollbar="true">
			<!-- 清单列表 -->
			<block v-for="(item, index) in labelList" :key="index">
				<view class="tui-rank-list">
					<view class="tui-tab-rank">
						...
						<view class="tag-tit3-flex">
							...
							<view class="tag-tit2-text"><tui-numberbox :min="1" :max="99" :value="value2" @change="change2"></tui-numberbox></view>
						</view>
					</view>
				</view>
